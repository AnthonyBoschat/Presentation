...
if(isset($_POST["data"]))
{
    ...
    $query_save_todo = $PDO -> prepare("INSERT INTO todo_list(user_name, todo_categorie, todo_content, todo_color)
                                        VALUES
                                        (:user_name, :todo_categorie, :todo_content, :todo_color)");
    $query_save_todo->bindValue(":user_name", $object->user_name);
    $query_save_todo->bindValue(":todo_categorie", $object->todo_categorie);
